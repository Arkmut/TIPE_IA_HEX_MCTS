...
arbreGeneral1 = initialisation(plateau)
...
while(pasDeGagnant):
    ...
    while(caseOccupee):
        if joueur == 1:
            arbreCoups1 = mcts(arbreGeneral1, cheminGeneral1, arbreCoups1, plateau)
    ...
    if joueur == 2: #On actualise l'arbre de recherche de l'IA avec le coup de l'adversaire
        arbreCoups1 = rechercheCoup(arbreCoups1, plateau, cheminGeneral1)
